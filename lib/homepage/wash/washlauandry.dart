          ...
          child: Column(
            children: [
              ...
              ListView.builder(
                ...
                shrinkWrap: true,
                itemCount: washer.length,
                itemBuilder: (BuildContext context, int index) {
                  washermodel washerlist = washer[index];
                  return ListTile(
                    onTap: () {
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      child: CheckboxListTile(
                                          ...
                                          title: Text('ล้างถังฆ่าเชื้่อโรค'),
                                          subtitle: Text('+ ฿10'),
                                          value: ischeck,
                    ...
                    trailing:
                        SvgPicture.asset('assets/svgassets/downcursor.svg'),
                    subtitle: Column(
              ...
              ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  dryermodel dryerlist = dryer[index];
                  return ListTile(
